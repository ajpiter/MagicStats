...
Fultz <- rbind(Fultz2018, Fultz2019, Fultz2020) 
...
#WIth the Magic Fultz saw increased playing time, which correlated to a higher GameScore
ggplot(Fultz, aes(x = Minutes, y = GmSc, color = Team)) + 
  geom_jitter() +
  ggtitle("Fultz Career Game Score") + 
  xlab("Minutes Played") + 
  ylab("Game Score") + 
...
#Fultz Career Points 
ggplot(Fultz, aes(x = PlayerGame, y = PTS, color = Team)) + 
  geom_jitter() +
  geom_smooth(se= FALSE) +
  ggtitle("Fultz Career Points") + 
  xlab("Game Played") + 
  ylab("Points") + 
  theme_classic() + 
  theme(axis.text.x = element_blank(), axis.ticks = element_blank(), axis.line = element_line(linetype = "blank"))

#Fultz Career Rebounds 
ggplot(Fultz, aes(x = TRB, y = PTS, color = Team)) + 
  geom_jitter() +
  ggtitle("Fultz Career Stats") + 
  xlab("Rebounds") + 
  ylab("Points") + 
  theme_classic() + 
  theme(axis.ticks = element_blank(), axis.line = element_line(linetype = "blank"))

##### Export Data Table as Excel Saved on Local Drive ##### 
getwd()
setwd("/Users/computername/Documents/MagicStats/Data")
openxlsx::write.xlsx(Fultz, file = "1.11.20 Fultz Stats.xlsx")
openxlsx::write.xlsx(Fultz2018, file = "Fultz 2018 Stats.xlsx")
openxlsx::write.xlsx(Fultz2019, file = "Fultz 2019 Stats.xlsx")
openxlsx::write.xlsx(Fultz2020, file = "Fultz 2020 Stats.xlsx")
openxlsx::write.xlsx(Fultz2021, file = "Fultz 2021 Stats.xlsx")
